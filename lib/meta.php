...
if ( ! class_exists( 'NgfbMeta' ) ) {
	...
	class NgfbMeta {
		...
		protected function get_submit_opts( $mod_id ) {
			...
			$opts = empty( $_POST[ NGFB_META_NAME ] ) ?		// make sure we have an array
