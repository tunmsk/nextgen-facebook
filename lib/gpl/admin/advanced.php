	...
	class NgfbGplAdminAdvanced {
		...
		public function filter_plugin_content_rows( $table_rows, $form ) {
			...
			$form->get_th_html( _x( 'Maximum Images from Content',
				'option label', 'nextgen-facebook' ), null, 'plugin_content_img_max' ).
			'<td class="blank">'.$this->p->options['plugin_content_img_max'].'</td>';

			$table_rows[] = '<tr class="hide_in_basic">'.
			$form->get_th_html( _x( 'Maximum Videos from Content',
				'option label', 'nextgen-facebook' ), null, 'plugin_content_vid_max' ).
		...
		public function filter_plugin_integration_rows( $table_rows, $form ) {
			...
			$form->get_th_html( _x( 'Honor the FORCE_SSL Constant',
				'option label', 'nextgen-facebook' ), null, 'plugin_honor_force_ssl' ).
			...
			$form->get_th_html( _x( 'Create Missing WP Media Sizes',
				'option label', 'nextgen-facebook' ), null, 'plugin_create_wp_sizes' ).
		...
		public function filter_plugin_social_rows( $table_rows, $form, $network = false ) {
			...
			foreach ( array( 
				...
				'og_img' => sprintf( _x( 'Add %s Column in', 'option label', 'nextgen-facebook' ), 
					sprintf( _x( '%s Img', 'column title', 'nextgen-facebook' ),
						$this->p->cf['menu_label'] ) ),
				'og_desc' => sprintf( _x( 'Add %s Column in', 'option label', 'nextgen-facebook' ), 
					sprintf( _x( '%s Desc', 'column title', 'nextgen-facebook' ),
						$this->p->cf['menu_label'] ) ),
			) as $key => $label ) {
				switch ( $key ) {
					case 'og_desc':
			...
			$table_rows['plugin_wpseo_social_meta'] = $form->get_th_html( _x( 'Read Yoast SEO Social Meta',
				'option label', 'nextgen-facebook' ), null, 'plugin_wpseo_social_meta' ).
		...
		public function filter_plugin_cache_rows( $table_rows, $form, $network = false ) {
			...
			$table_rows['plugin_head_cache_exp'] = $form->get_th_html( _x( 'Head Markup Array Cache Expiry',
				'option label', 'nextgen-facebook' ), null, 'plugin_head_cache_exp' ).
			...
			$table_rows['plugin_shorten_cache_exp'] = $form->get_th_html( _x( 'Shortened URL Cache Expiry',
				'option label', 'nextgen-facebook' ), null, 'plugin_shorten_cache_exp' ).
			...
			$form->get_th_html( _x( 'Filtered Content Text Cache Expiry',
				'option label', 'nextgen-facebook' ), null, 'plugin_content_cache_exp' ).
			...
			$form->get_th_html( _x( 'Get Image (URL) Size Cache Expiry',
				'option label', 'nextgen-facebook' ), null, 'plugin_imgsize_cache_exp' ).
			...
			$form->get_th_html( _x( 'Schema Types Array Cache Expiry',
				'option label', 'nextgen-facebook' ), null, 'plugin_types_cache_exp' ).
			...
			$form->get_th_html( _x( 'Show Cache Purge Count on Update',
				'option label', 'nextgen-facebook' ), null, 'plugin_show_purge_count' ).
			...
			$form->get_th_html( _x( 'Clear Short URLs on Clear All Cache',
				'option label', 'nextgen-facebook' ), null, 'plugin_clear_short_urls' ).
		...
		public function filter_plugin_apikeys_rows( $table_rows, $form ) {
			...
			$table_rows['plugin_bitly_token'] = $form->get_th_html( '<a href="https://bitly.com/a/oauth_apps" target="_blank">'.
				_x( 'Bitly Generic Access Token', 'option label', 'nextgen-facebook' ).'</a>', null, 'plugin_bitly_token' ).
			...
			$form->get_th_html( '<a href="http://bitly.com/a/your_api_key" target="_blank">'.
				_x( 'or Bitly API Key (deprecated)', 'option label', 'nextgen-facebook' ).'</a>', null, 'plugin_bitly_api_key' ).
