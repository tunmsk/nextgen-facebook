				 ...
				 */
					...
					switch ( $idx ) {
						...
						case 'tooltip-plugin_head_attr_filter':
							$text = 'By default, '.$atts['short'].' hooks the \'language_attributes\' filter to modify the &amp;lt;html&amp;gt; attributes for the Schema itemscope. The &amp;lt;head&amp;gt; element is actually the preferred location for this markup but WordPress does not offer a filter hook for &amp;lt;head&amp;gt; attributes. If your theme has a filter for its &amp;lt;head&amp;gt; attributes, enter its name here. Alternatively, you can use the '.$atts['short'].' Schema attributes function instead. Example template code: <pre><code>&amp;lt;head &amp;lt;?php function_exists(\''.$atts['lca'].'_schema_attributes\') ?<br/>&nbsp;&nbsp;&nbsp;&nbsp;'.$atts['lca'].'_schema_attributes() : \'\'; ?&amp;gt;&amp;gt;</code></pre> If you use this function in your header.php template, leave this option empty.';
							break;
						/*
