			 ...
			 */
				...
				switch ( $idx ) {
					...
					case 'notice-missing-schema_logo_url':
						$text = __( 'An Organization logo image is missing for the Schema Organization markup.', 'nextgen-facebook' ).' '.
						sprintf( __( 'Please enter a Website / Organization logo image URL in the %1$s settings.', 'nextgen-facebook' ),
					...
					case 'notice-missing-schema_banner_url':
						$text = __( 'An Organization banner image is missing for the Schema Organization markup.', 'nextgen-facebook' ).' '.
						sprintf( __( 'Please enter a Website / Organization banner (600x60px) image URL in the %1$s settings.', 'nextgen-facebook' ),
							( $this->p->is_avail['json'] ? '<a href="'.$this->p->util->get_admin_url( 'schema-json-ld' ).'">Schema Markup</a>' :
								'<a href="'.$this->p->util->get_admin_url( 'general#sucom-tabset_pub-tab_google' ).'">Google / Schema</a>' ) );
						break;
