				 ...
				 */
					...
					switch ( $idx ) {
						...
						case 'tooltip-meta-og_img_url':
							$text = __( 'A custom image URL (instead of an Image ID) to include first in the Facebook / Open Graph, and "Large Image Summary" Twitter Card meta tags.', 'nextgen-facebook' ).' '.__( 'Please make sure your custom image is large enough, or it may be ignored by the social website(s).', 'nextgen-facebook' ).' '.$fb_recommends.' <em>'.__( 'This field is disabled if a custom Image ID has been selected.', 'nextgen-facebook' ).'</em>';
							break;
			 ...
			 */
				...
				switch ( $idx ) {
					case 'notice-image-rejected':
						...
						$text = __( 'The Select Media tab in the Social Settings metabox can be used to select a larger image specifically for social / SEO purposes.', 'nextgen-facebook' );
