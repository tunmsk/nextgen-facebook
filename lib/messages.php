				...
				switch ( $idx ) {
					case 'pro-feature-msg':
						if ( $this->p->check->aop( $lca, false ) )
							$text = '<p class="pro-feature-msg"><a href="'.$url['purchase'].'" target="_blank">'.sprintf( __( 'Purchase %s licence(s) to modify the following options and install / enable Pro modules', 'nextgen-facebook' ), $atts['short_pro'] ).'</a></p>';
						else $text = '<p class="pro-feature-msg"><a href="'.$url['purchase'].'" target="_blank">'.sprintf( __( 'Purchase the %s plugin to modify the following options and install / enable Pro modules', 'nextgen-facebook' ), $atts['short_pro'] ).'</a></p>';
						break;
					case 'pro-option-msg':
				...
				switch ( $idx ) {
					case 'side-purchase':
						...
						if ( $this->p->is_avail['aop'] )
							$text .= sprintf( __( '%s can be purchased quickly and easily via Paypal &mdash; allowing you to license and enable Pro version features within seconds of your purchase.', 'nextgen-facebook' ), $atts['short_pro'] );
						else $text .= sprintf( __( '%s can be purchased quickly and easily via Paypal &mdash; allowing you to update the plugin within seconds of your purchase.', 'nextgen-facebook' ), $atts['short_pro'] );
						$text .= ' '.__( 'Pro version licenses do not expire &mdash; there are no yearly or recurring fees for updates and support.', 'nextgen-facebook' );
						$text .= '<p>';
						break;
					case 'side-help':
						$submit_text = __( 'Save All Plugin Settings', 'nextgen-facebook' );
						$text = '<p>'.sprintf( __( 'Metaboxes (like this one) can be opened / closed by clicking on their title bar, moved and re-ordered by dragging them, or removed / added from the <em>Screen Options</em> tab (top-right of page).', 'nextgen-facebook' ).' '.__( 'Settings in multiple tabs can be edited before clicking the \'%s\' button.', 'nextgen-facebook' ), $submit_text ).'</p>';
						break;
					default:
