				...
				if ( strpos( $idx, 'tooltip-meta-' ) === 0 ) {
					switch ( $idx ) {
						...
						case 'tooltip-meta-schema_is_main':
							$text = __( 'Check this option if the Schema markup describes the main content (aka "main entity") of this webpage.', 'nextgen-facebook' );
						 	break;
						case 'tooltip-meta-schema_type':
							$text = __( 'The Schema item type that defines the Schema markup and/or the meta tags of this webpage.', 'nextgen-facebook' );
						 	break;
			 ...
			 */
				...
				switch ( $idx ) {
					case 'notice-image-rejected':
						...
						$text = __( 'A larger and/or different custom image &mdash; specifically for social / SEO meta tags and markup &mdash; can be selected in the Social Settings metabox under the <em>Select Media</em> tab.', 'nextgen-facebook' );
