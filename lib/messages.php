				 ...
				 */
					...
					switch ( $idx ) {
						...
						case 'tooltip-rp_author_name':
							$text = __( 'Pinterest ignores Facebook-style Author Profile URLs in the <code>article:author</code> Open Graph meta tags.', 'nextgen-facebook' ).' '.__( 'A different meta tag value can be used when the Pinterest crawler is detected.', 'nextgen-facebook' ).' '.sprintf( __( 'Select an %1$s for the <code>%2$s</code> meta tag or \'[None]\' to disable this feature (the recommended value is \'Display Name\').', 'nextgen-facebook' ), _x( 'Author Name Format', 'option label', 'nextgen-facebook' ), 'article:author' );
							break;
