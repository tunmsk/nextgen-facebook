				 ...
				 */
					...
					switch ( $idx ) {
						...
						case 'tooltip-plugin_bitly_api_key':
							$text = sprintf( __( 'Your Bit.ly API key for this website (see <a href="%s" target="_blank">Your Bit.ly API Key</a> for details).', 'nextgen-facebook' ), 'https://bitly.com/a/your_api_key' );
							break;
