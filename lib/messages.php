			 ...
			 */
				...
				switch ( $idx ) {
					case 'notice-image-rejected':
						...
						$text = __( 'A larger and/or different image &mdash; specifically for social / SEO meta tags and markup &mdash; can be selected in the Social Settings metabox under the <em>Select Media</em> tab.', 'nextgen-facebook' );
