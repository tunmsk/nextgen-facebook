			 ...
			 */
				...
				switch ( $idx ) {
					...
					case 'info-plugin-tid-network':
						...
						break;
					case 'info-review':
						$text = '<blockquote class="top-info"><p>'.sprintf( __( 'If you appreciate the features, quality and support of this plugin, please <a href="%1$s" target="_blank">take a moment to rate the %2$s plugin on WordPress.org</a>.', 'nextgen-facebook' ), $url['review'], $atts['short'] ).' '.sprintf( __( 'Your rating will help other WordPress users find higher quality and well supported plugins &mdash; along with <strong>encouraging us to keep improving %s</strong> as well!', 'nextgen-facebook' ), $atts['short'] ).' ;-)</p></blockquote>';
						break;
			 ...
			 */
				...
				switch ( $idx ) {
					...
					case 'notice-header-tmpl-default-head':
						...
						$text = '<p><b>'.__( 'Your header.php theme template does not support Schema markup of webpage headers.', 'nextgen-facebook' ).'</b> '.sprintf( __( 'The %s element in your header.php theme template should include a filter function call for its attributes.', 'nextgen-facebook' ), '<code>&lt;head&gt;</code>' ).' '.sprintf( __( '%1$s can update the header.php theme template automatically for you to change the default %2$s element to:', 'nextgen-facebook' ), $atts['short'], '<code>&lt;head&gt;</code>' ).'</p><pre><code>&lt;head &lt;?php echo apply_filters( \'head_attributes\', \'\' ); ?&gt;&gt;</code></pre><p>'.sprintf( __( '<b><a href="%1$s">Click here to update the header.php theme template automatically</a></b> &mdash; or <a href="%2$s">modify the template yourself using the WordPress editor</a>.', 'nextgen-facebook' ), $update_url, $edit_url ).'</p><p>'.sprintf( __( 'Note: This template sanity check is only performed when updating the %s plugin, updating a theme, or activating a new theme.', 'nextgen-facebook' ), $atts['short'] ).'</p>';
						break;
