				...
				switch ( $idx ) {
					case 'side-purchase':
						...
						if ( $this->p->is_avail['aop'] ) {
							$text .= sprintf( __( '<strong>%s can be purchased quickly and easily via Paypal</strong> &mdash; allowing you to license the Pro version within seconds of your purchase.', 'nextgen-facebook' ), $info['short_pro'] );
						} else {
							$text .= sprintf( __( '<strong>%s can be purchased quickly and easily via Paypal</strong> &mdash; allowing you to update the Free plugin within seconds of your purchase.', 'nextgen-facebook' ), $info['short_pro'] );
						}
						$text .= '</p><p>'.__( 'Pro version licenses do not expire &mdash; there are no yearly or recurring fees for updates and support.', 'nextgen-facebook' ).'</p>';
						break;
					case 'side-help-support':
						$text = '<p>'.sprintf( __( '<strong>The development of %1$s is driven mostly by customer requests</strong> &mdash; we welcome your comments and suggestions!', 'nextgen-facebook' ), $info['short'] ).'</p>';
						break;
					default:
