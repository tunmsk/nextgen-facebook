			 ...
			 */
				...
				switch ( $idx ) {
					...
					case 'pro-about-msg-post':
						...
						// no break
					case 'pro-about-msg':
						$text = '<p class="pro-about-msg">'.sprintf( __( 'The Free / Basic version of %1$s does not include modules required to customize post, term, and/or user meta &mdash; these options are shown for informative purposes only.', 'nextgen-facebook' ), $info['short'] ).
