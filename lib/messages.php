			 ...
			 */
				...
				switch ( $idx ) {
					...
					case 'pro-about-msg-post':
						...
						// no break
					case 'pro-about-msg':
						$text = '<p class="pro-about-msg">'.sprintf( __( 'The Free / Basic version of %1$s does not include the modules required to manage custom post, taxonomy, or user meta &mdash; these options are included for display purposes only.', 'nextgen-facebook' ), $info['short'] ).( empty( $info['text'] ) ? '' : ' '.$info['text'] ).'</p>';
						break;
					default:
