				...
				if ( strpos( $idx, 'tooltip-side-' ) === 0 ) {
					switch ( $idx ) {
						...
						case 'tooltip-side-author-json-ld':
							$text = __( 'Add author (Person) social profiles markup to webpage headers in schema.org JSON-LD format for Google Search.', 'nextgen-facebook' );
							break;
						...
						case 'tooltip-side-publisher-json-ld':
							$text = __( 'Add publisher (Organization) social profiles markup to webpage headers in schema.org JSON-LD format for Google Search.', 'nextgen-facebook' );
							break;
						...
						case 'tooltip-side-website-json-ld':
							$text = __( 'Add Website markup to webpage headers in schema.org JSON-LD format for Google Search. The Website markup includes the home page URL, name, alternate name, and search query URL.', 'nextgen-facebook' );
							break;
						/*
						 * Pro version
						 */
