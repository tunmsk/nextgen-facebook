				...
				if ( strpos( $idx, 'tooltip-side-' ) === 0 ) {
					switch ( $idx ) {
						...
						case 'tooltip-side-wp-image-upscaler':
							$text = $atts['short_pro'].' includes an optional feature than allows it to upscale ALL WordPress Media Library images <em>when necessary</em> &mdash; up to a maximum upscale percentage. You can enable the WP Image Upscaler from the '.$this->p->util->get_admin_url( 'advanced#sucom-tabset_plugin-tab_integration', 'Advanced Settings' ).' page.';
							break;
				 ...
				 */
					...
					switch ( $idx ) {
						...
						case 'tooltip-plugin_upscale_images':
							$text = 'WordPress does not upscale (enlarge) images from smaller full-size originals &mdash; WordPress only generates smaller images from larger full-size originals. Upscaled images do not look as sharp or clean when upscaled, and if enlarged too much, images will look fuzzy and unappealing &mdash; not something you want to promote on your website (and social sites). '.$atts['short'].' includes an optional feature that allows it to upscale ALL Media Library images <em>when necessary</em>. <strong>Do not enable this option unless you want to publish lower quality images on your website and social sites</strong>.';
							break;
						case 'tooltip-plugin_upscale_img_max':
							$text = 'When upscaling of WordPress Media Library images is enabled, '.$atts['short'].' can make sure smaller / thumbnail images are not upscaled beyond reason, which could publish very lower quality / fuzzy images on your website and social sites (the default maximum is 20%). If an image needs to be upscaled beyond this meximum value &ndash; <em>in either width or height</em> &ndash; it will be ignored.';
							break;
				 ...
				 */
					...
					switch ( $idx ) {
						...
						case 'tooltip-google_schema_author_name':
							$text = sprintf( __( 'Select an \'%1$s\' for the author (Person) schema markup or \'[none]\' to disable this feature (the recommended value is \'Display Name\').', 'nextgen-facebook' ), _x( 'Author Name Format', 'option label', 'nextgen-facebook' ) );
							break;
				 ...
				 */
					...
					switch ( $idx ) {
						...
						case 'tooltip-rp_author_name':
							$text = __( 'Pinterest ignores Facebook-style Author Profile URLs in the \'article:author\' Open Graph meta tags.', 'nextgen-facebook' ).' '.__( 'A different \'article:author\' meta tag can be used when the Pinterest crawler is detected.', 'nextgen-facebook' ).' '.sprintf( __( 'Select an \'%1$s\' for the \'%2$s\' meta tag or \'[none]\' to disable this feature (the recommended value is \'Display Name\').', 'nextgen-facebook' ), _x( 'Author Name Format', 'option label', 'nextgen-facebook' ), 'article:author' );
							break;
			 ...
			 */
				...
				switch ( $idx ) {
					...
					case 'info-plugin-tid-network':
						...
						break;
					case 'info-review':
						$text = '<blockquote class="top-info"><p>'.sprintf( __( 'How do you like the plugin? Please take a moment to <a href="%1$s" target="_blank">rate the %2$s plugin on WordPress.org</a>.', 'nextgen-facebook' ), $url['review'], $atts['short'] ).' '.sprintf( __( 'Ratings help the WordPress community as a whole find higher-quality plugins &mdash; along with <strong>encouraging us to keep improving %s</strong> as well!', 'nextgen-facebook' ), $atts['short'] ).' ;-)</p></blockquote>';
						break;
					...
					case 'info-pub-twitter':
						$text = '<blockquote class="top-info"><p><strong>'.__( 'The Photo, Gallery, and Product Cards were deprecated by Twitter on July 3rd, 2015.', 'nextgen-facebook' ).'</strong> '.sprintf( __( '%1s continues to support all <a href="%2s">current Twitter Card formats</a>, including the Summary, Summary with Large Image, mobile App (extension plugin required), and video Player Cards (Pro version required).', 'nextgen-facebook' ), $atts['short'], 'https://dev.twitter.com/cards/types' ).'</p></blockquote>';
						break;
					case 'info-cm':
