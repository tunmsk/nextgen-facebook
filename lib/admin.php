	...
	class NgfbAdmin {
		...
		protected function add_side_meta_boxes() {
			...
			if ( ! self::$pkg[$lca]['aop'] ) {
				...
				NgfbUser::reset_metabox_prefs( $this->pagehook, array( 'purchase_pro' ) );
			}
		...
		protected function get_submit_buttons( $submit_text = '', $css_class = 'submit-buttons' ) {
			 ...
			 */
			$secondary = array(
				'clear_all_cache' => _x( 'Clear All Caches', 'submit button', 'nextgen-facebook' ),
				'check_for_updates' => _x( 'Check for Updates', 'submit button', 'nextgen-facebook' ),
