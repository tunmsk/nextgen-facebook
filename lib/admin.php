	...
	class NgfbAdmin {
		...
		protected function add_side_meta_boxes() {
			...
			if ( ! self::$pkg[$lca]['aop'] ) {
				...
				NgfbUser::reset_metabox_prefs( $this->pagehook, array( 'purchase' ) );
			}
