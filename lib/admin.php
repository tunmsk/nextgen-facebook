	...
	class NgfbAdmin {
		...
		public function show_metabox_version_info() {
			...
			foreach ( $this->p->cf['plugin'] as $ext => $info ) {
				...
				echo '<tr><th class="column">'._x( 'Installed', 'column label', 'nextgen-facebook' ).':</th>
					<td class="column-version" '.$installed_style.'>'.$installed_version.'</td></tr>';

				echo '<tr><th class="column">'._x( 'Stable', 'column label', 'nextgen-facebook' ).':</th>
					<td class="column-version">'.$stable_version.'</td></tr>';

				echo '<tr><th class="column">'._x( 'Latest', 'column label', 'nextgen-facebook' ).':</th>
