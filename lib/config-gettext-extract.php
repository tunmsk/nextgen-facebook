...
_x( 'NGFB Desc', 'column header', 'nextgen-facebook' );
...
_x( 'NGFB Img', 'column header', 'nextgen-facebook' );
_x( 'NGFB', 'menu label', 'nextgen-facebook' );
_x( 'NGFB Schema', 'column header', 'nextgen-facebook' );
...
_x( 'SoundCloud Business URL', 'option value', 'nextgen-facebook' );
