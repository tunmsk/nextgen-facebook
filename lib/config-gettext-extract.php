...
_x( '120px', 'option value', 'nextgen-facebook' );
_x( '12%', 'option value', 'nextgen-facebook' );
_x( '37px', 'option value', 'nextgen-facebook' );
_x( '70px', 'option value', 'nextgen-facebook' );
...
_x( 'auto', 'option value', 'nextgen-facebook' );
...
_x( 'meta_value', 'option value', 'nextgen-facebook' );
...
_x( '_ngfb_head_info_og_desc', 'option value', 'nextgen-facebook' );
_x( '_ngfb_head_info_og_img_thumb', 'option value', 'nextgen-facebook' );
_x( '_ngfb_head_info_schema_type', 'option value', 'nextgen-facebook' );
