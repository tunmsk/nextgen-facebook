...
if ( ! class_exists( 'NgfbUtil' ) && class_exists( 'SucomUtil' ) ) {
	...
	class NgfbUtil extends SucomUtil {
		...
		public function clear_all_cache( $clear_ext = true, $msg_id = false, $dismiss = false ) {
			...
			$clear_all_msg = sprintf( __( '%s cached files, transient cache, sortable column meta, and the WordPress object cache have all been cleared.', 'nextgen-facebook' ), $short );
