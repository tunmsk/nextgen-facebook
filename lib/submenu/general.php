			...
			switch ( $metabox.'-'.$key ) {
				...
				case 'pub-google':
					...
					$table_rows['schema_social_json'] = $this->form->get_th_html( _x( 'Google Knowledge Graph',
						'option label', 'nextgen-facebook' ), '', 'schema_social_json' ).
					'<td>'.
					...
					$this->form->get_th_html( _x( 'Item Type by Post Type',
						'option label', 'nextgen-facebook' ), '', 'schema_type_for_ptn' ).
					'<td>'.$schema_by_ptn.'</td>';
				...
				case 'pub-pinterest':
					...
					$table_rows['rp_publisher_url'] = $this->form->get_th_html( _x( 'Pinterest Company Page URL',
						'option label', 'nextgen-facebook' ), '', 'rp_publisher_url', array( 'is_locale' => true ) ).
					...
					$this->form->get_th_html( _x( 'Pinterest Verification ID',
						'option label', 'nextgen-facebook' ), '', 'rp_dom_verify' ).
				...
				case 'pub-other':
					...
					$table_rows['instgram_publisher_url'] = $this->form->get_th_html( _x( 'Instagram Business URL',
						'option label', 'nextgen-facebook' ), '', 'instgram_publisher_url', array( 'is_locale' => true ) ).
					...
					$table_rows['linkedin_publisher_url'] = $this->form->get_th_html( _x( 'LinkedIn Company Page URL',
						'option label', 'nextgen-facebook' ), '', 'linkedin_publisher_url', array( 'is_locale' => true ) ).
					...
					$table_rows['myspace_publisher_url'] = $this->form->get_th_html( _x( 'MySpace Business Page URL',
						'option label', 'nextgen-facebook' ), '', 'myspace_publisher_url', array( 'is_locale' => true ) ).
