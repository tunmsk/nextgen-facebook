	...
	class NgfbSubmenuGeneral extends NgfbAdmin {
		...
		public function show_metabox_opengraph() {
			...
			$tabs = apply_filters( $this->p->cf['lca'].'_'.$metabox.'_tabs', array( 
				...
				'content' => _x( 'Title / Descriptions', 'metabox tab', 'nextgen-facebook' ),	// same text as Social Settings tab
			...
			switch ( $metabox.'-'.$key ) {
				...
				case 'pub-facebook':
					...
					$rows[] = $this->p->util->get_th( _x( 'Facebook Admin Username(s)',
						'option label', 'nextgen-facebook' ), 'highlight', 'fb_admins' ).
					...
					$rows[] = $this->p->util->get_th( _x( 'Author Name Format',
						'option label', 'nextgen-facebook' ), 'highlight', 'google_author_name' ).
