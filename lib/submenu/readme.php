	...
	class NgfbSubmenuReadme extends NgfbAdmin {
		...
		public function show_metabox_readme() {
			...
			$tabs = apply_filters( $this->p->cf['lca'].'_'.$metabox.'_tabs', array( 
				'description' => _x( 'Description', 'normal metabox tab', 'nextgen-facebook' ),
				'faq' => _x( 'FAQ', 'normal metabox tab', 'nextgen-facebook' ),
				'notes' => _x( 'Other Notes', 'normal metabox tab', 'nextgen-facebook' ),
				'changelog' => _x( 'Changelog', 'normal metabox tab', 'nextgen-facebook' ),
			) );
			$rows = array();
