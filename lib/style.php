	...
	class SucomStyle {
		...
		public function admin_enqueue_styles( $hook_name ) {
			...
			wp_register_style( 'sucom-settings-page',
				NGFB_URLPATH.'css/com/settings-page.min.css',
...
<style type="text/css">
	...
	body#plugin-information #section-other_notes h3 {
		...
		private function add_admin_page_style( $hook_name ) {
			...
			wp_enqueue_style( 'sucom-admin-page',
				NGFB_URLPATH.'css/com/admin-page.min.css',
					array(), $plugin_version );
	...
	@font-face {
		font-family: "Star";
		src: url("'.NGFB_URLPATH.'fonts/star.eot");
		src: url("'.NGFB_URLPATH.'fonts/star.eot?#iefix") format("embedded-opentype"),
		url("'.NGFB_URLPATH.'fonts/star.woff") format("woff"),
		url("'.NGFB_URLPATH.'fonts/star.ttf") format("truetype"),
		url("'.NGFB_URLPATH.'fonts/star.svg#star") format("svg");
		font-weight: normal;
		font-style: normal;
	}
	.column-ngfb_og_img { 
