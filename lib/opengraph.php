	...
	class NgfbOpengraph {
		...
		public function get_the_media_urls( $size_name, $post_id, $md_pre = 'og', $output = array( 'image', 'video' ) ) {
			if ( function_exists( '_deprecated_function' ) )
				_deprecated_function( __METHOD__, '8.27.0.0', 'get_the_media_info' );
			return array();
		}

		// used by some sharing buttons (buffer, pinterest, tumblr)
		// creates image and video information for a specific $size_name ('ngfb-buffer-button' for example)
		...
		public static function get_first_media_url( $prefix, $og ) {
			if ( function_exists( '_deprecated_function' ) )
				_deprecated_function( __METHOD__, '8.27.0.0', 'get_first_media_info' );
			return '';
		}
