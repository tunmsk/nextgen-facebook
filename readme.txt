...
**Version 8.39.2-dev1 (2017/01/23)**

* *New Features*
	* None
* *Improvements*
	* Added a new "Clear Short URLs on Clear All Cache" option (default is unchecked) to preserve or clear shortened URLs when clearing all NGFB cache transients (Pro version). The default unchecked value for this option prevents updating all shortened URLs at once, which may exceed API call limits imposed by your shortening service provider.
