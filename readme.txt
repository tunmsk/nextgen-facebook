...
<p><strong>NGFB uses <em>existing</em> content to generate meta tags and Schema markup</strong> &mdash;</p>
...
<p>NGFB provides all the information social websites need, improving <em>Google Search ranking</em>, <em>social engagement</em>, and <em>click-through-rates</em> on Facebook, Google+, Twitter, Pinterest, LinkedIn, and many more. NGFB includes special support and optimization features specifically for Pinterest (to avoid incompatible meta tags and Schema markup).</p>
...
* *Improvements*
	...
	* Added a check in 'ngfb_init_objects' to allow / prevent caching the default options array.
* *Bugfixes*
	* None
* *Developer Notes*
