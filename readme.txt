...
<img src="https://surniaulula.github.io/nextgen-facebook/assets/icon-256x256.png" width="128" height="128" class="plugin_icon">
...
(2017/01/26) Added a missing second argument for the NgfbUtil clear_cache_objects() method when clearing the cache for updated terms and users.
...
(2017/01/21) Improved the loading speed of post, term, and user editing table column content (NGFB Schema, NGFB Img, and NGFB Desc columns).
