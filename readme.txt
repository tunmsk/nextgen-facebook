...
* **Developer Notes**
	...
	* Added new filters to customize the image pattern matching in the content:
		* apply_filters( 'ngfb_content_images_tags_preg_or', $tags_preg = 'img' );
		* apply_filters( 'ngfb_content_images_attr_preg_or', $attr_preg = 'data-[a-z]+-pid' );
...
* **Developer Notes**
	...
	* Renamed a few variables and methods for improve readability:
		...
		* Renamed the NgfbHead `get_tag_array()` private method to `get_mt_array()`.
		* Renamed the NgfbHead `get_single_tag()` private method to `get_single_mt()`.
...
* **New Features**
	* *None*
* **Improvements**
	* Added Twitter Card features in the Free version.
