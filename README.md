...
<p align="center"><img src="https://surniaulula.github.io/nextgen-facebook/assets/icon-256x256.png" /></p><p><strong>Make sure all social websites present your content in the best possible way, no matter <em>how</em> your webpage is shared</strong> &mdash; from sharing buttons on the webpage, web browser add-ons / extensions, or URLs pasted directly on timelines and in private messages (PM).</p>
